...
public class EventCenter 
{
	...
	/**
	 * Trigger an event. Note that the {@code javaQuery} function parameter will be {@code null}.
	...
	/**
	 * Trigger an event.
	 * @param javaQuery the instance of javaQuery to pass as a parameter
	 * @param text the name of the event
	 * @param args the arguments to pass to the registered functions
	 * @param scope the scope of the event
	 */
	public static void trigger($ javaQuery, String text, Map<String, Object> args, Object scope)
	{
		if (scope == null) scope = global;
		Map<String, List<Function>> triggers = receivers.get(scope);
		if (triggers == null)
