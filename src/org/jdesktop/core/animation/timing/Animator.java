...
import org.jdesktop.core.animation.timing.KeyFrames.Builder;
 ...
 * @see Builder
 */
@Modified(author="Phil Brown", summary="Greatly modified to remove Builder class and get working nicely with a custom AnimatorSet class.")
@ThreadSafe
@Region("private AnimatorState")
@RegionLock("AnimatorLock is f_lock protects AnimatorState")
public class Animator implements TickListener, Cloneable {
...
public <T extends Animator>T setDuration(long value, TimeUnit unit) {
    if (value < 1)
   ...
   * @return this builder (to allow chained operations).
   */
  public void setEndBehavior(Animator.EndBehavior value) {
   ...
   * @return this builder (to allow chained operations).
   */
  public void setRepeatBehavior(Animator.RepeatBehavior value) {
   ...
   * @return this builder (to allow chained operations).
   */
  public void setStartDirection(Animator.Direction value) {
  ...
  @Modified(author="Phil Brown", summary="changed all these to protected, not private final")
  /**
  ...
  @Modified(author="Phil Brown", summary="Changed all to protected")
  protected String f_debugName = null;
  protected long f_duration = 1;
  protected TimeUnit f_durationTimeUnit = TimeUnit.SECONDS;
  protected Animator.EndBehavior f_endBehavior = Animator.EndBehavior.HOLD;
  protected Interpolator f_interpolator = null; // use the built-in default
  protected Animator.RepeatBehavior f_repeatBehavior = Animator.RepeatBehavior.REVERSE;
  protected long f_repeatCount = 1;
  protected Animator.Direction f_startDirection = Animator.Direction.FORWARD;
  protected TimingSource f_timingSource;
   ...
   */
  @Modified(author="Phil Brown", summary="changed to protected, not private")
  protected CopyOnWriteArrayList<TimingTarget> f_targets = new CopyOnWriteArrayList<TimingTarget>();
   ...
   */
  @Modified(author="Phil Brown", summary="changed to protected, not private final")
   ...
   */
  @Unique("return")
  @Modified(author="Phil Brown", summary="changed to protected")
  public Animator() {
	  f_timingSource = f_defaultTimingSource.get();
  }
  ...
  public Animator clone()
  {
	  try {
          ...
          if (f_targets != null) {
              CopyOnWriteArrayList<TimingTarget> oldListeners = f_targets;
              anim.f_targets = new CopyOnWriteArrayList<TimingTarget>();
              int numListeners = oldListeners.size();
              for (int i = 0; i < numListeners; ++i) {
                  anim.f_targets.add(oldListeners.get(i));
              }
          }
          return anim;
  ...
  @Modified(author="Phil Brown", summary="Added accessor")
  public CopyOnWriteArrayList<TimingTarget> getTargets()
  {
	  return f_targets;
  }
